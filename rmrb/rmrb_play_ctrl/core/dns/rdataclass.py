...
class UnknownRdataclass(rmrb_play_ctrl.core.dns.exception.DNSException):
...
def from_text(text):
    ...
    @type text: string
    @rtype: int
    @raises rmrb_play_ctrl.core.dns.rdataclass.UnknownRdataclass: the class is unknown
